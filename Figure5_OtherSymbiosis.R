...
### Figure 5: PIDA Comparison - SYMBIOSIS ###
### By: Samantha Gleich ###
...
# Legend
ggplot(taxz,aes(x=1:10,y=2:11,fill=fin))+geom_point(size=3,shape=21)+scale_fill_manual(name="Taxonomic Group",values=c(taxCols))+theme_classic()+theme(legend.position="bottom")
ggsave("Legend.pdf")
